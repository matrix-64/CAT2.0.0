...
class mouseModeCAT:
    ...
    def action(self,sh,fings):
        ...
        if sh[1] == 25 :
            self.act_subMove(fings[1][1][0],fings[1][1][1])
            self.mouse.down()
        else :
            self.mouse.up()
            if sh[1] == 24 :
        ...
        if sh[1] == 12 : self.act_scroll(fings[1][0][1])

        self.cus_bef = [fings[1][1][0], fings[1][1][1]]
        self.R_zero_bef = [fings[1][0][0], fings[1][0][1]]
